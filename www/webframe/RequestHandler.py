...
@author: bomber
'''
from webframe import has_request_arg, has_var_kw_args, get_named_kw_args, \
    get_required_kw_args, has_named_kw_args
from aiohttp import web
from urllib import parse
import logging
from webframe.APIErrors import APIError
import os
import inspect
import asyncio
...
def add_static(app):
    path = os.path.join(os.path.dirname(os.path.abspath('./www')), 'static')
